...
function Xd(){var a=Yd(),b={};db(Wd(),function(c){a.sandbox&&a.sandbox.supports&&a.sandbox.supports(c)&&(b[c]=!0)});
return b}
function Yd(){var a=void 0===a?document:a;return a.createElement("iframe")}
;function Zd(a){this.isValid=a}
function $d(a){return new Zd(function(b){return b.substr(0,a.length+1).toLowerCase()===a+":"})}
var ae=[$d("data"),$d("http"),$d("https"),$d("mailto"),$d("ftp"),new Zd(function(a){return/^[^:]*([/?#]|$)/.test(a)})];function be(a){"number"==typeof a&&(a=Math.round(a)+"px");return a}
...
r(Mh,H);
var Nh=[23,24,11,6,7,5,2,3,20,21,28,32,37,229,241,45,59,225,288,72,73,78,208,156,202,215,74,76,79,80,111,85,91,97,100,102,105,119,126,127,136,146,157,158,159,163,164,168,176,222,383,177,178,179,411,184,188,189,190,191,193,194,195,196,198,199,200,201,203,204,205,206,258,259,260,261,209,226,227,232,233,234,240,247,248,251,254,255,270,278,291,293,300,304,308,309,310,311,313,314,319,321,323,324,328,330,331,332,337,338,340,344,348,350,351,352,353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,
378,380,381,388,389,403,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117];var Oh={Uh:0,Fh:1,Lh:2,Mh:4,Rh:8,Nh:16,Oh:32,Th:64,Sh:128,Hh:256,Jh:512,Qh:1024,Ih:2048,Kh:4096,Gh:8192,Ph:16384};function Ph(a){H.call(this,a)}
...
Pa.compatMode?Pa.documentElement:Pa.body;var F=(new Pd(va.clientWidth,va.clientHeight)).round()}catch(ua){F=new Pd(-12245933,-12245933)}Pa=F;F={};var Ca=void 0===Ca?y:Ca;va=new kf;Ca.SVGElement&&Ca.document.createElementNS&&va.set(0);D=Xd();D["allow-top-navigation-by-user-activation"]&&va.set(1);D["allow-popups-to-escape-sandbox"]&&va.set(2);Ca.crypto&&Ca.crypto.subtle&&va.set(3);Ca.TextDecoder&&Ca.TextEncoder&&va.set(4);Ca=lf(va);F.bc=Ca;F.bih=Pa.height;F.biw=Pa.width;F.brdim=v.join();b=b.j;b=(F.vis=
...
function Cn(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=An(a,b,c,d);if(e)return e;e=++zn.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new xn(h);if(!Sd(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new xn(h);
...
Xa(Fn,I);Fn.prototype.W=function(a){void 0===a.i&&yn(a);var b=a.i;void 0===a.j&&yn(a);this.j=new Od(b,a.j)};
...
"LATENCY_ACTION_CREATOR_DIALOG_UPLOADS",T.direct_playback="LATENCY_ACTION_DIRECT_PLAYBACK",T.embed="LATENCY_ACTION_EMBED",T.entity_key_serialization_perf="LATENCY_ACTION_ENTITY_KEY_SERIALIZATION_PERF",T.entity_key_deserialization_perf="LATENCY_ACTION_ENTITY_KEY_DESERIALIZATION_PERF",T.explore="LATENCY_ACTION_EXPLORE",T.home="LATENCY_ACTION_HOME",T.library="LATENCY_ACTION_LIBRARY",T.live="LATENCY_ACTION_LIVE",T.live_pagination="LATENCY_ACTION_LIVE_PAGINATION",T.onboarding="LATENCY_ACTION_ONBOARDING",
...
function Ct(a,b,c,d){d=void 0===d?null:d;var e=Rd("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Mt(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,xt(c,function(){window[g]?Nt(a,d,g,e):(a.state=3,Dt(c),Wp(new Q("Unable to load Botguard","from "+c)))},f)):b?(f=Rd("SCRIPT"),f.textContent=b,f.nonce=Xb(),document.head.appendChild(f),document.head.removeChild(f),window[g]?Nt(a,d,g,e):(a.state=4,Wp(new Q("Unable to load Botguard from JS")))):Wp(new Q("Unable to load VM; no url or JS provided"))}
...
function yu(a){var b=Rd("A");Bb("This URL is never added to the DOM");Ub(b,new Jb(a,Kb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Zb(a)}
...
function Lu(a){var b=Qd(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
...
cv(d,b,h)}else cv(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=gc(a,k)+m;var t=void 0===t?ae:t;a:{t=void 0===t?ae:t;for(k=0;k<t.length;++k)if(m=t[k],m instanceof Zd&&m.isValid(a)){t=new Jb(a,Kb);break a}t=void 0}c.href=Lb(t||Nb)}return!0}
